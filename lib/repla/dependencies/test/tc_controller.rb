...
class TestController < Test::Unit::TestCase
  ...
  def test_missing_dependency
    ...
    test_result_name = Repla::Dependencies::Tests::JavaScriptHelper.last_name(@controller.view)
    ...
    test_result_type = Repla::Dependencies::Tests::JavaScriptHelper.last_type(@controller.view)
  ...
  def test_missing_with_installation_instructions
    ...
    dependency = Repla::Dependencies::Dependency.new('asdf', :shell_command, installation_instructions: test_installation)
    ...
    test_result_installation = Repla::Dependencies::Tests::JavaScriptHelper.last_installation(@controller.view)
  ...
  def test_mutiple_missing_dependencies
    test_installation = 'Using <a href="http://brew.sh/">Homebrew</a>, <code>brew install asdf</code>'
    dependency_with_installation = Repla::Dependencies::Dependency.new('asdf', :shell_command, installation_instructions: test_installation)
    dependency = Repla::Dependencies::Dependency.new('asdf', :shell_command)
    ...
    test_result_count_name = Repla::Dependencies::Tests::JavaScriptHelper.count_name(@controller.view)
    test_result_count_type = Repla::Dependencies::Tests::JavaScriptHelper.count_type(@controller.view)
    test_result_count_installation = Repla::Dependencies::Tests::JavaScriptHelper.count_installation(@controller.view)
